import { installLocalVoiceBridge } from "./voice-bridge.js?v=6.4.0";
import { resolveStartupVoiceLanguage } from "./text-pipeline.js?v=6.4.0";
...
async function boot() {
  ...
  inferenceWorkerUrl.searchParams.set("release", "6.4.0");
  const replacements = [

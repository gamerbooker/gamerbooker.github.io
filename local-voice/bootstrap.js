import { installLocalVoiceBridge } from "./voice-bridge.js?v=6.7.0";
import { resolveStudioStartup, resolveVoiceQuality } from "./quality-config.js?v=6.7.0";
...
async function boot() {
  ...
  inferenceWorkerUrl.searchParams.set("release", "6.7.0");
  const replacements = [
    [

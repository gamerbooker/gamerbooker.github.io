import { installLocalVoiceBridge } from "./voice-bridge.js?v=6.5.6";
import { resolveStudioStartup, resolveVoiceQuality } from "./quality-config.js?v=6.5.6";
...
async function boot() {
  ...
  inferenceWorkerUrl.searchParams.set("release", "6.5.6");
  const replacements = [
    [

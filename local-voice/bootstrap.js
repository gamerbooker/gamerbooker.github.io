import { installLocalVoiceBridge } from "./voice-bridge.js?v=6.5.9";
import { resolveStudioStartup, resolveVoiceQuality } from "./quality-config.js?v=6.5.9";
...
async function boot() {
  ...
  inferenceWorkerUrl.searchParams.set("release", "6.5.9");
  const replacements = [
    [
